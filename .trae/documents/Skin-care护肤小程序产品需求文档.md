...
Skin-care 是一款专为谷雨品牌打造的智能护肤微信小程序，集成AI皮肤检测、个性化护肤方案、产品知识库和体验官管理系统。通过科技赋能提升用户护肤体验，为品牌收集用户数据并建立高活跃度社群。
...
| 体验官 | 邀请码升级或品牌方指定 | 普通用户权限 + 任务领取、报告提交、积分兑换、内测社群 |
| 管理员 | 后台系统分配 | 用户管理、内容管理、任务发布、数据分析 |

### 2.2 Feature Module

我们的护肤小程序包含以下核心页面：

1. **首页**：品牌展示、快速检测入口、每日护肤提醒、用户成长状态
2. **皮肤检测页**：AI拍照检测、问卷评估、检测报告、历史对比
3. **个人档案页**：皮肤档案、护肤方案、数据趋势、成就徽章
4. **护肤日记页**：每日打卡、图文记录、数据可视化、智能分析
5. **产品知识库页**：产品详情、成分词典、搭配推荐、使用指南
6. **体验官中心页**：任务列表、报告提交、积分管理、社群交流
7. **个人中心页**：用户信息、设置选项、隐私管理、客服支持
...
| 体验官中心页 | 任务管理 | 任务列表、进度跟踪、截止时间提醒 |
| 体验官中心页 | 报告系统 | 结构化报告模板、前后对比、改进建议 |
| 体验官中心页 | 积分系统 | 积分获取记录、兑换商城、排行榜 |
| 个人中心页 | 用户设置 | 个人信息编辑、隐私设置、通知偏好 |

## 3. Core Process

### 普通用户流程
用户首次使用小程序时，通过微信登录并完成皮肤档案创建，包括AI检测和问卷填写。系统生成个性化护肤方案后，用户可以每日记录护肤日记，定期进行皮肤检测跟踪变化。同时可以浏览产品知识库学习护肤知识。

### 体验官流程
体验官除了拥有普通用户的所有功能外，还可以在任务中心领取品牌方发布的试用任务，完成产品体验后提交结构化报告，获得积分奖励。在内测社群中与其他体验官交流心得，形成高质量的用户反馈。
...
| 产品页面 | 产品卡片 | 产品图片，评分星级，价格标签，收藏按钮 |
| 体验官页面 | 任务卡片 | 任务状态标签，进度条，截止时间倒计时 |
